...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText(std::to_string(blueScore).c_str(), (int)(GetRenderWidth() / 2 - 195),
                 (int)(GetRenderHeight() / 2 - 10), 20, BLUE);
        DrawText(std::to_string(greenScore).c_str(), (int)(GetRenderWidth() / 2 - 20),
                 (int)(GetRenderHeight() / 2 - 10), 20, GREEN);
        DrawText(std::to_string(redScore).c_str(), (int)(GetRenderWidth() / 2 + 165), (int)(GetRenderHeight() / 2 - 10),
                 20, RED);
